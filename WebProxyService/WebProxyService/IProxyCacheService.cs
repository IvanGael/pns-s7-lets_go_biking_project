...
namespace WebProxyService
{
    ...
    public interface IProxyCacheService
    {
        ...
        List<StaticStation> GetStationsByContract(string contract);

        [OperationContract]
        [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json,
            BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "station?numero={numero}&contract={contract}")]
        DynamicStation GetOneStation(int numero, string contract);
