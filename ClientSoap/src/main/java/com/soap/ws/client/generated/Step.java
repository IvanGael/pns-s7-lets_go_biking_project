...
@XmlType(name = "Step", namespace = "http://schemas.datacontract.org/2004/07/RoutingWithBikesHost.OpenRouteServiceAPI", propOrder = {
    "distance",
    "duration",
    "instruction",
    "name",
...
public class Step {
    ...
    @XmlElementRef(name = "instruction", namespace = "http://schemas.datacontract.org/2004/07/RoutingWithBikesHost.OpenRouteServiceAPI", type = JAXBElement.class, required = false)
    protected JAXBElement<String> instruction;
    @XmlElementRef(name = "name", namespace = "http://schemas.datacontract.org/2004/07/RoutingWithBikesHost.OpenRouteServiceAPI", type = JAXBElement.class, required = false)
