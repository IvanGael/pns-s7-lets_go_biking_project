 ...
 *         &lt;element name="geometry" type="{http://schemas.datacontract.org/2004/07/RoutingWithBikesHost.OpenRouteServiceAPI}Geometry" minOccurs="0"/&gt;
 *         &lt;element name="properties" type="{http://schemas.datacontract.org/2004/07/RoutingWithBikesHost.OpenRouteServiceAPI}Properties" minOccurs="0"/&gt;
...
@XmlType(name = "Feature", namespace = "http://schemas.datacontract.org/2004/07/RoutingWithBikesHost.OpenRouteServiceAPI", propOrder = {
    "bbox",
    "geometry",
    "properties",
    "type"
...
public class Feature {
    ...
    @XmlElementRef(name = "geometry", namespace = "http://schemas.datacontract.org/2004/07/RoutingWithBikesHost.OpenRouteServiceAPI", type = JAXBElement.class, required = false)
    protected JAXBElement<Geometry> geometry;
    @XmlElementRef(name = "properties", namespace = "http://schemas.datacontract.org/2004/07/RoutingWithBikesHost.OpenRouteServiceAPI", type = JAXBElement.class, required = false)
