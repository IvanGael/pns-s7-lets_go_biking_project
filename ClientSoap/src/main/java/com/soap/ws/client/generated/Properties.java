 ...
 *       &lt;sequence&gt;
 *         &lt;element name="segments" type="{http://schemas.datacontract.org/2004/07/RoutingWithBikesHost.OpenRouteServiceAPI}ArrayOfSegment" minOccurs="0"/&gt;
 *         &lt;element name="summary" type="{http://schemas.datacontract.org/2004/07/RoutingWithBikesHost.OpenRouteServiceAPI}Summary" minOccurs="0"/&gt;
...
@XmlType(name = "Properties", namespace = "http://schemas.datacontract.org/2004/07/RoutingWithBikesHost.OpenRouteServiceAPI", propOrder = {
    "segments",
    "summary",
    "wayPoints"
})
public class Properties {
    ...
    @XmlElementRef(name = "segments", namespace = "http://schemas.datacontract.org/2004/07/RoutingWithBikesHost.OpenRouteServiceAPI", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfSegment> segments;
    @XmlElementRef(name = "summary", namespace = "http://schemas.datacontract.org/2004/07/RoutingWithBikesHost.OpenRouteServiceAPI", type = JAXBElement.class, required = false)
    protected JAXBElement<Summary> summary;
    @XmlElementRef(name = "way_points", namespace = "http://schemas.datacontract.org/2004/07/RoutingWithBikesHost.OpenRouteServiceAPI", type = JAXBElement.class, required = false)
