...
@XmlType(name = "Contract", namespace = "http://schemas.datacontract.org/2004/07/WebProxyService.ReferenceObjects", propOrder = {
    "cities",
    "commercialName",
    "countryCode",
    "name"
...
public class Contract {
    ...
    @XmlElementRef(name = "cities", namespace = "http://schemas.datacontract.org/2004/07/WebProxyService.ReferenceObjects", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfstring> cities;
    @XmlElementRef(name = "commercial_name", namespace = "http://schemas.datacontract.org/2004/07/WebProxyService.ReferenceObjects", type = JAXBElement.class, required = false)
    protected JAXBElement<String> commercialName;
    @XmlElementRef(name = "country_code", namespace = "http://schemas.datacontract.org/2004/07/WebProxyService.ReferenceObjects", type = JAXBElement.class, required = false)
